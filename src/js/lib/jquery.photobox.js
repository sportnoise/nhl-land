...
;(function($, doc, win){
    ...
    var Photobox, photobox, options, images=[], imageLinks, activeImage = -1, activeURL, lastActive, activeType, prevImage, nextImage, thumbsStripe, docElm, APControl, changeImage,
        ...
        defaults = {
            ...
            captionTmpl   : '<div class="counter">{currentImageIdx} из {totalImagesCount}</div>',
        ...
        overlay = $('<div id="pbOverlay">').append(
            ...
            caption = $('<div id="pbCaption">').append(
                $('<div class="container block">').append(
                    $('<div class="block-left">').append(
                        autoplayBtn = $('<div id="pbAutoplayBtn">'),
                        '<button title="Rotate right" class="rotateBtn"></button>',
                        '<label for="pbThumbsToggler" title="Show/hide thumbnails"></label>',
                    ),
                    $('<div class="block-center">').append(
                        prevBtn = $('<div id="pbPrevBtn" class="prevNext"></div>').on('click', next_prev),
                        captionText = $('<div class="pbCaptionText">'),
                        nextBtn = $('<div id="pbNextBtn" class="prevNext"></div>').on('click', next_prev),
                    ),
                    $('<div class="block-right">').append(
